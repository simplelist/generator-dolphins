...
module.exports = class {
  ...
  create() {
    ...
    this.generator.fs.copyTpl(this.generator.templatePath(`_ModelController.java`), this.generator.destinationPath(`${baseDestPath}/controller/${data.entityClass}Controller.java`), data)
